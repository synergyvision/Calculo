...
1. $\displaystyle\int\frac{x}{x-6}dx$

2. $\displaystyle\int\frac{r^2}{r+4}dr$

3. $\displaystyle\int\frac{x-9}{(x+5)(x-2)}dx$

4. $\displaystyle\int\frac{1}{(t+4)(t-1)}dt$

5. $\displaystyle\int_2^3\frac{1}{x^2-1}dx$
